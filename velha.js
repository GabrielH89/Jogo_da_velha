...
function exibe() {
   HTML = '<table  cellpadding="30" border="10">';
...
function jogar() {
   /*O %2 abaixo é responsável por alternar as jogadas entre os dois jogadores*/ 
   /*%3 Se fossem 3 jogadores e assim sucessivamente*/
